...
namespace AcctMan.Infrastructure.Migrations
{
    ...
    [Migration("20240812155717_ModifiedDBContetxt")]
    partial class ModifiedDBContetxt
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcctMan.Domain.Entities.Wallet", b =>
                {
                    b.HasOne("AcctMan.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AcctMan.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
